...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <h4 style="font-weight: bold">Price: <span class="currency" id="price"><?php echo $get_room_price; ?></span> / Day</h4>
                                    <h4 style="font-weight: bold">Total Amount : <span id="total_price">0</span> </h4>
                                    <h4 hidden style="font-weight: bold">Total Amount : <span class="currency" id="total_price">0</span> </h4>
                                </div>
                            </div>
                        </div>
                    <?php } else{?>
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="col-lg-12">
                                    <h4 style="font-weight: bold">Total Days : <span id="staying_day">0</span> Days</h4>
                                    <h4 style="font-weight: bold">Price: <span class="currency" id="price">0</span> / Day</h4>
                                    <h4 style="font-weight: bold">Total Amount : <span  class="currency"  id="total_price">0</span> </h4>
                                </div>
                            </div>
                        </div>
                    <?php }
    ...
    <div class="row">
        <div class="col-sm-12">
            <p class="back-link">Made with ❤️by Abah, Joseph Israel</p>
        </div>
    </div>
