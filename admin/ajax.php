...
if (isset($_POST['add_room'])) {
    ...
    if ($room_no != '') {
        ...
        if (mysqli_num_rows(mysqli_query($connection, $sql)) >= 1) {
            ...
            $query = "INSERT INTO room (room_type_id,room_no,check_in_status,check_out_status) VALUES ('$room_type_id','$room_no',false,false)";
            $result = mysqli_query($connection, $query);
...
if (isset($_GET['delete_room'])) {
    ...
    $result = mysqli_query($connection, $sql);
    if ($result) {
        header("Location:admin/index.php?room_mang&success");
    } else {
        header("Location:admin/index.php?room_mang&error");
    }
}
...
if (isset($_POST['createComplaint'])) {
    ...
    $query = "INSERT INTO complaint (complainant_name,complaint_type,complaint,resolve_status) VALUES ('$complainant_name','$complaint_type','$complaint',false)";
    $result = mysqli_query($connection, $query);
    if ($result) {
        header("Location:admin/index.php?complain&success");
    } else {
        header("Location:admin/index.php?complain&error");
    }
...
if (isset($_POST['resolve_complaint'])) {
    ...
    $result = mysqli_query($connection, $query);
    if ($result) {
        header("Location:admin/index.php?complain&resolveSuccess");
    } else {
        header("Location:admin/index.php?complain&resolveError");
    }
}
...
if (isset($_POST['change_shift'])) {
    ...
    if ($result && $insert_result && $update_result) {
        header("Location:admin/index.php?staff_mang&success");
    } else {
        header("Location:admin/index.php?staff_mang&error");
    }
}
